...
const ProductCard = (product: ProductCardProps) => {
  ...
  return (
    <div 
      ...
      className={cn(
        "group bg-white rounded-[40px] p-4 pb-6 transition-all duration-500 shadow-xl hover:shadow-2xl hover:-translate-y-2 border border-slate-100/50 cursor-pointer",
      ...
      <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden mb-6 shadow-inner bg-slate-50">
        ...
        {isOutOfStock && (
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center backdrop-blur-sm z-10">
            <span className="bg-red-600 text-white font-black px-6 py-2 rounded-2xl shadow-2xl transform -rotate-6 tracking-widest uppercase text-sm">
              Sold Out
            </span>
          </div>
        )}
