...
export const CodLedgerTab = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Filters & Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[10px] border border-slate-100 shadow-sm">
        <div>
        ...
        <div className="w-[240px]">
          <Select value={selectedAgentId} onValueChange={setSelectedAgentId}>
            <SelectTrigger className="rounded-[10px] border-slate-200 bg-slate-50 font-bold h-11">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="rounded-[10px] border-none shadow-xl shadow-emerald-500/5 bg-gradient-to-br from-emerald-50 to-white overflow-hidden relative group">
        ...
        <Card className="rounded-[10px] border-none shadow-xl shadow-amber-500/5 bg-gradient-to-br from-amber-50 to-white overflow-hidden relative group">
          <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 transition-transform">
        ...
        <Card className="rounded-[10px] border-none shadow-xl shadow-blue-500/5 bg-gradient-to-br from-blue-50 to-white overflow-hidden relative group">
          <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 transition-transform">
      ...
      <Tabs defaultValue="requests" className="w-full">
        <TabsList className="bg-white border border-slate-100 p-1 rounded-[10px] h-14 w-full md:w-fit mb-6 shadow-sm">
          <TabsTrigger value="requests" className="rounded-[10px] font-bold text-xs uppercase tracking-widest px-6 gap-2 data-[state=active]:bg-primary data-[state=active]:text-white transition-all">
          ...
          <TabsTrigger value="balances" className="rounded-[10px] font-bold text-xs uppercase tracking-widest px-6 gap-2 data-[state=active]:bg-primary data-[state=active]:text-white transition-all">
            <Bike className="h-4 w-4" />
            Agent Balances
          </TabsTrigger>
          <TabsTrigger value="history" className="rounded-[10px] font-bold text-xs uppercase tracking-widest px-6 gap-2 data-[state=active]:bg-primary data-[state=active]:text-white transition-all">
        ...
        <TabsContent value="requests">
          <Card className="rounded-[10px] border-slate-100 shadow-xl overflow-hidden">
                      ...
                      <TableRow key={request.id} className="group hover:bg-amber-50/30 transition-colors border-slate-50">
                        ...
                        <TableCell className="text-right pr-8">
                          <Button 
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white font-black text-[10px] uppercase tracking-widest px-6 h-9 rounded-[10px] shadow-lg shadow-emerald-600/20"
                          >
                  ...
                  {deliveryBoys.map((db) => {
                    ...
                    return (
                      <TableRow key={db.user_id} className="border-slate-50 group hover:bg-slate-50 transition-colors">
                        ...
                        <TableCell className="text-right pr-8">
                          <span className={cn(
                            "inline-flex items-center px-4 py-1.5 rounded-[10px] font-black text-sm tracking-tight",
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          {entry.type === 'COLLECTION' ? 
                            <Badge variant="secondary" className="bg-emerald-50 text-emerald-700 border-emerald-100 rounded-[10px] text-[9px] font-black uppercase tracking-widest">Collection</Badge> : 
                            <Badge variant="secondary" className="bg-blue-50 text-blue-700 border-blue-100 rounded-[10px] text-[9px] font-black uppercase tracking-widest">Settlement</Badge>
                          }
                        </div>
                      </TableCell>
                      <TableCell className="font-black text-slate-900">
