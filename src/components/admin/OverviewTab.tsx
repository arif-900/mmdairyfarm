...
export function OverviewTab() {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/50 backdrop-blur-md p-4 rounded-2xl border border-white/40 shadow-soft">
                ...
                <div className="flex items-center gap-2">
                    <input
                        type="month"
                        className="bg-white border border-forest/10 rounded-lg px-4 py-2 text-sm font-bold text-forest focus:ring-2 focus:ring-forest outline-none shadow-sm transition-all"
                ...
                <CardContent>
                    <div className="space-y-3">
                        {filteredOrders.length === 0 ? (
                            ...
                            <div key={order?.id} className="bg-white p-4 rounded-xl flex items-center justify-between border-b last:border-0 border-gray-100 hover:bg-forest/[0.02] transition-colors group">
                                <div className="flex items-center gap-3">
                                    <div className="p-2 bg-forest/5 rounded-lg group-hover:bg-forest/10 transition-colors">
