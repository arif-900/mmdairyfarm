...
export const BillModal: React.FC<BillModalProps> = ({ order, isOpen, onClose }) => {
  ...
  const platformFee = order.total_amount - subtotal;
        ...
        <div className="p-0 overflow-y-auto bg-slate-100">
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-[0.06] z-0 select-none">
              <img src="https://i.ibb.co/s96b0wbK/IMG-20260308-WA0000.jpg" alt="" className="w-[450px] h-[450px] rounded-full object-cover" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-between items-start mb-10">
                <div className="flex gap-4 items-start">
                  <div className="w-20 h-20 bg-emerald-50 rounded-lg flex items-center justify-center border border-emerald-100 overflow-hidden">
                    <img src="https://i.ibb.co/s96b0wbK/IMG-20260308-WA0000.jpg" alt="Logo" className="w-full h-full object-cover" />
                  </div>
                  <div>
              ...
              <div className="grid grid-cols-2 gap-12 mb-12">
                ...
                <div className="flex flex-col justify-end items-end pb-2">
                  ...
                  <div className="text-right space-y-1">
                    <p className="text-sm font-bold text-slate-800">{order.delivery_type === 'daily' ? 'Subscription Plan' : 'Standard Delivery'}</p>
              ...
              <div className="flex justify-end mb-20">
                <div className="w-full max-w-[320px] space-y-4">
                  ...
                  <div className="flex justify-between items-center px-2">
                    <span className="text-sm font-medium text-slate-400">Platform Fee</span>
                    <span className="text-sm font-bold text-slate-700">+ ₹{platformFee.toLocaleString('en-IN')}</span>
                  </div>
