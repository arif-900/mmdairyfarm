  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-in-left": "slide-in-left 1.2s cubic-bezier(0.22, 1, 0.36, 1) forwards",
        "letter-wave": "letter-wave 2s ease-in-out infinite",
        "character-reveal": "character-reveal 6s ease-in-out infinite",
      },
      boxShadow: {
